...
\nonumber
&\vdots& \\
f_r(z) &=& a_0 + \cfrac{z}{a_1 + \cfrac{z-1}{a_2 + \cfrac{z- 2}{ \cfrac{\vdots}{a_{r-1} + \cfrac{z-r+1}{a_r}}}}},
\end{eqnarray}
where
\begin{eqnarray}
a_0 &=& f(0) \\
...
\nonumber
&\vdots& \\
a_r &=&\cfrac{1}{\cfrac{2}{\cfrac{3}{\cfrac{\vdots}{\cfrac{r}{f(r)-a_0}-a_1}} - a_{r-2}} - a_{r-1}} \\
...
>         (num, den) = t2r as (n+1)
\end{verbatim}
Here is a simple check, and it works.
...
3
*Univariate> let thieleFunc x = thiele' funcList x
*Univariate> map thieleFunc [0..4]
[1 % 1,3 % 2,13 % 7,73 % 34,12 % 5]
*Univariate> let asOfFunc = thieleC funcList 
*Univariate> asOfFunc 
[1 % 1,2 % 1,3 % 1,4 % 1]
*Univariate> thiele2ratf asOfFunc 
([16 % 1,16 % 1,1 % 1],[16 % 1,6 % 1])
...
\begin{verbatim}
  ...
  *Univariate> :t f
  f :: Num a => a -> a -> a
\end{verbatim}
First, fix $z_2=0,1,2$ and take $f(z_1,-)$ as our univariate polynomial.
\begin{verbatim}
  *Multivariate> let f z1 z2 = 3+2*z1+4*z2+7*z1^2+5*z1*z2+6*z2^2
  *Multivariate> let f0s = map (`f` 0) [0..]
  *Multivariate> let f1s = map (`f` 1) [0..]
  *Multivariate> let f2s = map (`f` 2) [0..]
  *Multivariate> map degreeLazy [f0s, f1s, f2s]
  [2,2,2]
  *Multivariate> map (degree . (take 10)) [f0s, f1s, f2s]
  [2,2,2]
\end{verbatim}
...
\begin{verbatim}
  *Multivariate> list2pol $ take 10 f0s
  [3 % 1,2 % 1,7 % 1]
  *Multivariate> list2pol $ take 10 f1s
  [13 % 1,7 % 1,7 % 1]
  *Multivariate> list2pol $ take 10 f2s
  [35 % 1,12 % 1,7 % 1]
\end{verbatim}
...
\begin{verbatim}
  ...
  *Multivariate> let g0s = map (g 0) [0..]
  *Multivariate> let g1s = map (g 1) [0..]
  *Multivariate> let g2s = map (g 2) [0..]
  *Multivariate> let g3s = map (g 3) [0..]
  *Multivariate> map degreeLazy [g0s, g1s, g2s, g3s]
  [2,2,2,2]
  *Multivariate> map (degree . (take 10)) [g0s, g1s, g2s, g3s]
  [2,2,2,2]
\end{verbatim}
...
\begin{verbatim}
  *Multivariate> list2pol $ take 10 g0s
  [1 % 1,8 % 1,9 % 1]
  *Multivariate> list2pol $ take 10 g1s
  [18 % 1,9 % 1,9 % 1]
  *Multivariate> list2pol $ take 10 g2s
  [55 % 1,10 % 1,9 % 1]
  *Multivariate> list2pol $ take 10 g3s
  [112 % 1,11 % 1,9 % 1]
\end{verbatim}
So we get
\begin{eqnarray}
...
and 
\begin{verbatim}  
  *Multivariate> degree [1,18,55,112]
  2
  *Multivariate> degree [8,9,10,11]
  1
  *Multivariate> list2pol [1,18,55,112]
  [1 % 1,7 % 1,10 % 1]
  *Multivariate> list2pol [8,9,10]
  [8 % 1,1 % 1]
\end{verbatim}
Finally we get
\begin{eqnarray}
c_0(x) = 1 + 7x+10x^2, c_1(x) = 8+x
\end{eqnarray}
and
\begin{eqnarray}
