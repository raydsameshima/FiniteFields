...
We use the same notion, i.e., what we can know is the output-list of a univariate rational function \texttt{f::Int -> Ratio Int}:
\begin{eqnarray}
\texttt{map f [0..]}
\end{eqnarray}
...
\nonumber
&\vdots& \\
f_r(z) &=& a_0 + \cfrac{z}{a_1 + \cfrac{z-1}{a_2 + \cfrac{z- 2}{\cdots + \cfrac{z-r+1}{a_r}}}},
\end{eqnarray}
where
\begin{eqnarray}
a_0 &=& f(0) \\
...
\begin{eqnarray}
a_0 + \cfrac{z)}{a_1 + \cfrac{z-1}{a_2 + \cfrac{z-2}{\cdots + a_{r-1}+ \cfrac{z-r+1}{a_r}}}} 
\end{eqnarray}
